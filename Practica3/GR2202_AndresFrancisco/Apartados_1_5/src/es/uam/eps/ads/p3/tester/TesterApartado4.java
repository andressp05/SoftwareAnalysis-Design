...
/**
 * Tester Apartado4 de la practica 3
...
public class TesterApartado4 {
	  public static void main(String[] args) {	 
		 ...
		 // Avanzamos un dia mas, los dos de vencimiento ayer, tambien estan vencidos hoy, total 3
	    ...
	    // Avanzamos unos dias mas, y los 4 prestamos estarin vencidos, y se van devolviendo
  		 FechaSimulada.avanzar( 3 );  
  		 System.out.println( "\nPasados de vencimiento " + FechaSimulada.getHoy()  );
  	     for (Prestamo p :  Prestamo.pasadosDeVencimiento() ) {  
  	    	 if ( p.devolver() ) System.out.println( p );   	    
  	     } 
  		 System.out.println( "\nYa no debe haber prestamos pasados de vencimiento " ); 
